...
import Logo from '../../../assets/images/marvel-logo-transparent.png'
      ...
      >
        <Toolbar className={classes.toolbarRoot}>
          <div className={classes.leftContent}>
            <img className={classes.logo} src={Logo} height={32} alt={'React Marvel Comics'} />
          ...
          <div className={classes.rightContent}>
            <FilterBar />
            <IconButton color="contrast" href="https://github.com/joaosouz4dev" target="_new">
